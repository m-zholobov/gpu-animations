Shader "GPU Animation/Unlit"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #pragma vertex GPUAnimUnlitVert
            #pragma fragment GPUAnimUnlitFrag
            ...
            Varyings GPUAnimUnlitVert(Attributes input)
            {
            ...
            half4 GPUAnimUnlitFrag(Varyings input) : SV_Target
            {
                UNITY_SETUP_INSTANCE_ID(input);
